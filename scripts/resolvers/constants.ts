...
/** 10 AI slop anti-patterns — shared between DESIGN_METHODOLOGY and DESIGN_HARD_RULES */
...
/** Hard rejection criteria (from OpenAI "Designing Delightful Frontends with GPT-5.4", Mar 2026) */
...
/** Litmus checks — 7 yes/no tests for cross-model consensus scoring */
