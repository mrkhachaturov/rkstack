...
2. Read plan file if it exists: look for `.rkstack/docs/plans/*.md` referencing this feature. Read PR description: `gh pr view --json body --jq .body 2>/dev/null || true`.
