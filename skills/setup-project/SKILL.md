...
**This is where Claude's intelligence matters.** The `.tmpl` skeleton has section headings and `[GENERATED]` placeholders. Claude reads the project, understands the structure, and writes content that fits — like the difference between a generic "Terraform rules" and your astrateam project's specific root ownership table.
