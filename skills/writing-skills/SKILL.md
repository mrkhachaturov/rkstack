...
- Mechanical constraints enforceable with automation (save documentation for judgment calls)
...
**Generic labels** -- "helper1", "step3", "pattern4" have no semantic meaning. Name by what they DO.
